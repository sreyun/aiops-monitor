...
- **纯安装速查**：见 [install.md](../getting-started/install.md)
...
> 对应官网首页 CTA「一条命令部署服务端，一条命令安装 Agent」。本章为完整落地流程；纯速查见 [install.md](../getting-started/install.md)。
...
完整配置、权限和接入示例见 [内容审计专家指南](./content-audit.md)。

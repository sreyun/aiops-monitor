...
Текущий релиз **[v0.19.60](https://github.com/sreyun/aiops-monitor/releases/tag/v0.19.60)** · Зеркала: [GitHub](https://github.com/sreyun/aiops-monitor) / [Gitee](https://gitee.com/bigdatasafe/aiops-monitor)

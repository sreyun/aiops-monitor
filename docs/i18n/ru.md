...
Текущий релиз **[v0.19.64](https://github.com/sreyun/aiops-monitor/releases/tag/v0.19.64)** · Зеркала: [GitHub](https://github.com/sreyun/aiops-monitor) / [Gitee](https://gitee.com/bigdatasafe/aiops-monitor)

...
> [INSTALL_EN.md](./install.en.md), it covers **production architecture, reverse proxy, gateway relay,
...
> For install steps, one-line Agent install, Android client, RBAC / MFA, see **[INSTALL_EN.md](./install.en.md)**.
